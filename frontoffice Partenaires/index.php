  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <div class="navbar-nav ms-auto p-4 p-lg-0">
        ...
        <!-- === VOTRE MENU PARTENAIRES === -->
        <div class="nav-item dropdown">
          <a href="#" class="nav-link dropdown-toggle" id="partenairesDropdown" data-bs-toggle="dropdown">
            Partenaires
          </a>
          <ul class="dropdown-menu bg-light m-0" aria-labelledby="partenairesDropdown">
            <!-- lien relatif vers PARTENAIRES/Partenaires.php -->
            <li><a href="PARTENAIRES/Partenaires.php" class="dropdown-item">Partenaires &amp; Offres</a></li>
            <!-- lien relatif vers PARTENAIRES/demandes.php -->
            <li><a href="PARTENAIRES/demandes.php" class="dropdown-item">Demandes</a></li>
          </ul>
        </div>
        <!-- =============================== -->

      </div>
      <a href="login.html" class="btn btn-primary py-4 px-lg-4 rounded-0 d-none d-lg-block">
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="">Partenaires</a>
