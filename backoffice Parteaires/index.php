...
<!-- Nav Item - Nos Partenaires -->
<!-- Nav Item - Nos Partenaires avec sous-menu -->
<li class="nav-item">
    ...
    <div id="collapsePartenaires" class="collapse" aria-labelledby="headingPartenaires" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="PARTENAIRE/Liste.php">Liste des Partenaires</a>
            <a class="collapse-item" href="PARTENAIRE/Demandes.php">Les demandes</a>
            <!-- Vous pouvez ajouter d'autres sous-menus si besoin -->
        </div>
    </div>
</li>
            ...
            <li class="nav-item">
               ...
               <div id="collapseGestion" class="collapse" aria-labelledby="headingGestion"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="depot.html">Comentaires</a>
                </div>
              </div>
          </li>
          ...
          <li class="nav-item">
           ...
           <div id="collapseLivraison" class="collapse" aria-labelledby="headingLivraison"
            data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Passer votre commande:</h6>
                <a class="collapse-item" href="commande.html">Commande</a>
                <a class="collapse-item" href="livraison.html">Livraison</a>
            </div>
          </div>
      </li>
