...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <?php if ($isLoggedIn): ?>
                <div class="nav-item dropdown">
                    <a href="#" class="btn btn-primary py-4 px-lg-4 rounded-0 d-none d-lg-block dropdown-toggle" data-bs-toggle="dropdown">
                        <i class="fas fa-user me-2"></i><?php echo htmlspecialchars($userEmail); ?>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end">
                        <a href="profile.php" class="dropdown-item">Mon Profil</a>
                        <a href="/mon_project_web/logout.php" class="dropdown-item">Se déconnecter</a>
                        <?php if ($userRole === 'admin'): ?>
                            <a href="/mon_project_web/view/backoffice/backoffice/index.php" class="dropdown-item">Administration</a>
                        <?php endif; ?>
                    </div>
                </div>
            <?php else: ?>
                <a href="login.php" class="btn btn-primary py-4 px-lg-4 rounded-0 d-none d-lg-block">Se connecter<i class="fa fa-arrow-right ms-3"></i></a>
            <?php endif; ?>
        </div>
    </nav>
    <!-- Navbar End -->
                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <h1 class="display-1 text-white mb-5 animated slideInDown">Sortir, rencontrer, et créer des amitiés enrichissantes !</h1>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7">
                                    <h1 class="display-1 text-white mb-5 animated slideInDown">Rencontrez, sortez, amusez-vous !</h1>
                                    <a href="" class="btn btn-primary py-sm-3 px-sm-4">Explore More</a>
                                </div>
                            </div>
                        </div>
