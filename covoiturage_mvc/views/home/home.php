...
<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            ...
            <!-- Covoiturage avec menu déroulant -->
    ...
    <a href="index.php?action=lister" class="dropdown-item">Consulter les covoiturages</a>
</div>
...
<!-- Navbar End -->
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <h1 class="display-1 text-white mb-5 animated slideInDown">
                                        Sortir, rencontrer, et créer des amitiés enrichissantes !
                                    </h1>
        ...
        <div class="container">
            <div class="row g-5 align-items-end">
                <div class="col-lg-3 col-md-5 wow fadeInUp" data-wow-delay="0.1s">
                    <img class="img-fluid rounded" data-wow-delay="0.1s" src="img/about.jpg" alt="">
                </div>
    ...
    <!-- Back to Top -->
    <a href="index.php?action=login" class="btn btn-primary py-4 px-lg-4 rounded-0 d-none d-lg-block" style="background-color: #090068; border: none;">
